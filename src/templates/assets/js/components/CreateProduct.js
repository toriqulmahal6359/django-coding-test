...
const CreateProduct = (props) => {
    ...
    let saveProduct = async (event) => {
        ...
        try{
            const response = await axios.post('http://127.0.0.1:8000/src/product/views/product.py', formData, {
                        ...
                        <div className="card shadow mb-4">
                            <div className="card-body">
                                <div className="form-group">
                                    ...
                                    <input type="text" name="name" placeholder="Product Name" className="form-control" value={productName} onChange={(e) => setProductName(e.target.value)}/>
                                </div>
                                <div className="form-group">
                                    <label htmlFor="">Product SKU</label>
                                    <input type="text" name="sku" placeholder="Product Name" className="form-control" value={productSKU} onChange={(e) => setProductSKU(e.target.value) } />
                                </div>
                                <div className="form-group">
                                    <label htmlFor="">Description</label>
                                    <textarea id="" cols="30" rows="4" name="sku" className="form-control" value={productDescription} onChange={(e) => setProductDescription(e.target.value)}></textarea>
                                </div>
                            </div>
                        </div>
